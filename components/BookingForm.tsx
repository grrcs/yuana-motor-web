...
export default function BookingForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'error',
        message: `Gagal booking: ${error.message || 'Terjadi kesalahan'}`
      });
    } finally {
          ...
          {submitStatus.type && (
            ...
            >
              ...
              <div className="flex-1">
                ...
                {submitStatus.bookingNumber && (
                  <p className="text-sm text-neutral-300 mt-2">
                    Simpan nomor booking untuk cek status nanti
                  </p>
                )}
              </div>
            </motion.div>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                disabled={isSubmitting}
                className="input-field w-full p-2 rounded bg-neutral-700 text-white resize-none disabled:opacity-50"
